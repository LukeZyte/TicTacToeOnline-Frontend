...
import { Box, Button, Card, Container, FormControl, FormHelperText, IconButton, InputAdornment, InputLabel, OutlinedInput, Stack, Typography } from '@mui/material';
...
const SignUp = () => {
    ...
    const onSignUpSubmit = (data: FormData) => {
        ...
        axiosInstance.post(ApiEndpoints.AuthRegister, {
            login: data.login,
            ...
            <Container maxWidth="sm">
                <Card variant='outlined' style={{padding: 32}}>
                    ...
                    <form onSubmit={handleSubmit(onSignUpSubmit)}>
                        <Stack gap={1} marginTop={4}>
                            <FormControl fullWidth error={!!errors.login}>
                                ...
                                <Controller
                                    ...
                                    control={control}
                                    defaultValue=""
                                    rules={{ required: "Login in required" }}
                                    render={({ field }) => <OutlinedInput id="login" label="Login" {...field} />}
                                />
                            ...
                            <FormControl fullWidth error={!!errors.repeatPassword}>
                                ...
                                <Controller
                                    ...
                                    rules={{
                                        ...
                                        validate: (value) => value === passwordValue || 'Repeat password must be the same as Password',
                                    }}
                                    render={({ field }) => (
                                        <OutlinedInput
                                            id="repeatPassword"
                        ...
                        <Stack gap={1} marginTop={4}>
                            <Button variant="contained" size="large" type="submit" loading={signupLoading}>Sign up</Button>
                            <Button variant="outlined" onClick={onSignInClick}>Log in to existing account</Button>
                        </Stack>
                    </form>
                </Card>
            </Container>
